...
// TODO(A): fold these namespaces into the app-wide i18next setup; the resource shape
// matches Person D's, so the two merge without renaming keys.
...
i18n.use(initReactI18next).init({
  resources: {
    en: { common: enCommon, leagues: enLeagues },
    es: { common: esCommon, leagues: esLeagues },
  },
  lng: initialLanguage(),
  fallbackLng: 'en',
  ns: ['common', 'leagues'],

...
export default function BadgeCard({ badge, onSelect, selected = false }) {
  ...
  return (
    <button
      ...
      className={`card relative flex min-h-[112px] w-full flex-col items-center justify-center gap-2 text-center ${selected ? 'ring-2 ring-sky' : ''} ${badge.earned ? '' : 'grayscale'}`}
    >

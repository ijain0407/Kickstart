...
export const dictionary = {
  en: {
    ...
    account: {
      title: 'Your account',
      sub: 'Sign in so your XP, streak and clubs follow you to any device.',
      signInTitle: 'Sign in',
      ...
      chants: 'chants',
      lessons: 'lessons',
      favouriteClub: 'Your club',
      noClub: 'No club picked yet',
      visitClub: 'Open their culture page',
      progressNote: 'Progress you have already earned moves across when you sign in.',
      syncNote: 'Saved to your account, not just this browser.',
      offlineNote: 'The app works without an account — progress stays on this device.',
      errors: {
        credentials: 'Email or password is incorrect.',
        taken: 'That email already has an account. Try signing in.',
        validation: 'Check the email address and make sure the password is at least 8 characters.',
        unavailable: 'Accounts are unavailable right now.',
      },
    },
    clubQuiz: {
      kicker: 'FIND YOUR CLUB',
      subtitle: "No right or wrong answers — we're matching you to a club that fits your style.",
      cta: 'Find your club',
      ctaSub: 'Five questions, and we will pick the club in this league that fits you.',
      match: 'match',
      resultsKicker: 'YOUR CLUB',
      resultsTitle: 'This one is yours.',
  ...
  es: {
    ...
    account: {
      title: 'Tu cuenta',
      sub: 'Inicia sesión para que tu XP, tu racha y tus clubes te sigan en cualquier dispositivo.',
      ...
      chants: 'cánticos',
      lessons: 'lecciones',
      favouriteClub: 'Tu club',
      noClub: 'Aún no has elegido club',
      visitClub: 'Abrir su página de cultura',
      progressNote: 'El progreso que ya has conseguido se traslada al iniciar sesión.',
      syncNote: 'Guardado en tu cuenta, no solo en este navegador.',
      offlineNote: 'La app funciona sin cuenta: el progreso se queda en este dispositivo.',
      errors: {
        credentials: 'El correo o la contraseña no son correctos.',
        taken: 'Ese correo ya tiene una cuenta. Prueba a iniciar sesión.',
        validation: 'Revisa el correo y comprueba que la contraseña tenga al menos 8 caracteres.',
        unavailable: 'Las cuentas no están disponibles ahora mismo.',
      },
    },
    clubQuiz: {
      kicker: 'ENCUENTRA TU CLUB',
      subtitle: 'No hay respuestas correctas o incorrectas: te emparejamos con el club que va con tu estilo.',
      cta: 'Encuentra tu club',
      ctaSub: 'Cinco preguntas y elegimos el club de esta liga que encaja contigo.',
      match: 'de coincidencia',
      resultsKicker: 'TU CLUB',
      resultsTitle: 'Este es el tuyo.',
